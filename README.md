...
|---------|----------------|
| `/mute_channel` | Текстовый канал наказания или бот-команды + `channel` |
| `/unmute_channel` | Текстовый канал или бот-команды + `channel` |
...
- [ ] `/mute_channel` в публичном канале — ephemeral ответ, запись в лог-канале, DM пользователю
- [ ] `/mute_channel` из бот-команд с `channel`
- [ ] Повторный mute — «продлил» в логах, новый срок
- [ ] `/unmute_channel` в канале и из бот-команд
